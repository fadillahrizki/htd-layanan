                    ...
                    <div class="col-12">
                        <div class="card card-body">
                            ...
                            foreach(config('fields')['pemohon'] as $key => $field): 
                                ...
                                if($label == "User" || $label == "Nama Layanan" || $label == "Hubungan Keluarga"){
                                    continue;
                                }
                            ?>
                ...
                <div class="row row-card-no-pd">
                    <div class="col-12">
                        <div class="card card-body">
                            ...
                            <div class="form-group">
                                <label for=""><?=$label?></label>
                                <?= Form::input($type, "data_mempelai_pria[".$field."]", ['class'=>"form-control","placeholder"=>$label,"value"=>$old[$field]??'']) ?>
                            </div>
                ...
                <div class="row row-card-no-pd">
                    <div class="col-12">
                        <div class="card card-body">
                            ...
                            <div class="form-group">
                                <label for=""><?=$label?></label>
                                <?= Form::input($type, "data_mempelai_wanita[".$field."]", ['class'=>"form-control","placeholder"=>$label,"value"=>$old[$field]??'']) ?>
                            </div>
                            <?php endif; endforeach ?>
                        </div>
                    </div>
                ...
                <div class="row row-card-no-pd">
                    <div class="col-12">
                        <div class="card card-body">
                            ...
                            <div class="form-group">
                                <label for=""><?=$label?></label>
                                <?= Form::input($type, "data_ayah_mempelai_pria[".$field."]", ['class'=>"form-control","placeholder"=>$label,"value"=>$old[$field]??'']) ?>
                            </div>
                            <?php endforeach ?>
                        </div>
                    </div>
                ...
                <div class="row row-card-no-pd">
                    <div class="col-12">
                        <div class="card card-body">
                            ...
                            <div class="form-group">
                                <label for=""><?=$label?></label>
                                <?= Form::input($type, "data_ibu_mempelai_pria[".$field."]", ['class'=>"form-control","placeholder"=>$label,"value"=>$old[$field]??'']) ?>
                            </div>
                            <?php endforeach ?>
                        </div>
                    </div>
                ...
                <div class="row row-card-no-pd">
                    <div class="col-12">
                        <div class="card card-body">
                            ...
                            <div class="form-group">
                                <label for=""><?=$label?></label>
                                <?= Form::input($type, "data_ayah_mempelai_wanita[".$field."]", ['class'=>"form-control","placeholder"=>$label,"value"=>$old[$field]??'']) ?>
                            </div>
                            <?php endforeach ?>
                        </div>
                    </div>
                ...
                <div class="row row-card-no-pd">
                    <div class="col-12">
                        <div class="card card-body">
                            ...
                            <div class="form-group">
                                <label for=""><?=$label?></label>
                                <?= Form::input($type, "data_kematian_suami[".$field."]", ['class'=>"form-control","placeholder"=>$label,"value"=>$old[$field]??'']) ?>
                            </div>
                            <?php endif ; endforeach ?>
                        </div>
                    </div>
                ...
                <div class="row row-card-no-pd">
                    <div class="col-12">
                        <div class="card card-body">
                            ...
                            <div class="form-group">
                                <label for=""><?=$label?></label>
                                <?= Form::input($type, "data_kematian_istri[".$field."]", ['class'=>"form-control","placeholder"=>$label,"value"=>$old[$field]??'']) ?>
                            </div>
                            <?php endif; endforeach ?>
                        </div>
                    </div>
