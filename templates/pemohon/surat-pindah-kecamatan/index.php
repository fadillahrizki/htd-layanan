            ...
            <div class="page-inner py-5">
                <div class="d-flex align-items-left align-items-md-center flex-column flex-md-row">
                    ...
                    <div class="ml-md-auto py-2 py-md-0">
                        <a href="<?=routeTo('pemohon/surat-pindah-kecamatan/create')?>" class="btn btn-secondary btn-round">Buat <?=_ucwords($table)?></a>
                    </div>
                </div>
            </div>
        </div>
                                    ...
                                    <tbody>
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                ...
                                                <?php endif ?>
                                                <a href="<?=routeTo('pemohon/surat-pindah-kecamatan/edit',['id'=>$data->id])?>" class="btn btn-sm btn-warning"><i class="fas fa-pencil-alt"></i> Edit</a>
